...
<head>
    ...
    <title>FilmWave Admin - Modifier un Tag</title>
            ...
            <header class="bg-white shadow">
                <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-3xl font-bold text-gray-900">Modifier le Tag</h1>
                    </div>
                </div>
            </header>
                ...
                <div class="p-6 bg-white rounded-lg shadow">
                    <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $tag->name) }}" class="block w-full px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
